...
// export const API_URL = "http://servertest4-001-site1.btempurl.com/api";


export const SERVER_URL = "http://specialistorg-001-site1.btempurl.com";
// export const SERVER_URL = "http://servertest4-001-site1.btempurl.com";
